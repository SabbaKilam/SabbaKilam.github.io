...
//=================================================================
/*
    A seemingly "saner" draggable alternative to DnD in AbbasLib.js
*/
 ...
 */
 ...
 function linkedListFactory(){
    ...
    //---------------------
    return listObject;
}//--END of linkedListFactory function
exports.linkedListFactory;
//===============================
//----------------------------------------------------------
/**
 * curry(function):
