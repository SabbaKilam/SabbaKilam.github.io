...
//=====IMPORTANT======================
//attach "main" as "$" on global object
this.$ = main;
//====================================
var elem = {};
var array = [];
...
main.adjustRem = function adjustRem(newMinimum, newDivisor){
    var validArguments = typeof newMinmum !== undefined &&
                    typeof newDivisor !== undefined &&
                    typeof newMinimum === "number" &&
                    typeof newDivisor === "number";       
    if(validArguments){
...
variable, domElements (that is previousily defined). Then I use the method
  main.attachDomElements() to make the references point to their proper DOM element.
